# Generated by Django 4.2.30 on 2026-04-12 10:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('farmer', 'Farmer'), ('operator', 'Warehouse Operator'), ('admin', 'Admin')], default='farmer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_crop', models.CharField(default='Maize', max_length=100)),
                ('cooperative_name', models.CharField(blank=True, max_length=200)),
                ('annual_production_bags', models.IntegerField(blank=True, help_text='Estimated bags per year (90kg)', null=True)),
